...
const Footer = () => {
  return (
    <div className="px-10 z-50 pt-12 pb-6 font-sans tracking-wide text-black bg-gray-50 dark:bg-gray-900 dark:text-white">
      <footer className="container mx-auto ">
        <div className="flex flex-wrap justify-between gap-10">
          <div className="max-w-md">
            ...
            <div className="mt-6">
              <p className="text-sm leading-relaxed ">
                A curated library of reusable and visually appealing front-end
                components built using modern web technologies like React.js,
                Tailwind CSS, and JavaScript.
              </p>
            </div>
            <ul className="flex mt-10 space-x-5">
          ...
          <div className="max-lg:min-w-[140px]">
            <h4 className="relative text-base font-semibold max-sm:cursor-pointer">
              Services
            </h4>
            ...
            <ul className="mt-6 space-y-4">
              <li>
                <a
                  ...
                  className="text-sm hover:text-mainColor"
                >
                  Web Development
                </a>
              </li>
    ...
    <>
      <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div className="w-full mb-10">
          <h4 className="text-lg font-semibold mb-9 dark:text-white">
            {header}
          </h4>
          <ul className="space-y-3 dark:text-white">{children}</ul>
        </div>
      </div>
    </>
  );
...
const NavLink = ({ link, label }) => {
  return (
    <li>
      <a
        href={link}
        className="inline-block text-base leading-loose text-body-color hover:text-primary dark:-6"
      >
        {label}
      </a>
    </li>
