...
export const FullComponentsView = ({
  children,
  code,
  className,
  link,
  ...
  const iframeContent = ReactDOMServer.renderToStaticMarkup(children);

  const iframeRef = useRef(null);

  //   for iframe size dynamically change

  const [iframeHeight, setIframeHeight] = useState('400px'); // Default height
  ...
  //     // Inject the script into the iframe's document
  ...
  return (
    <div className={` w-full h-auto mx-auto  ${className}`}>
      <div class=" mx-auto text-center mt-2 container">
      ...
      <div className="flex items-center justify-between w-full px-4 py-2 shadow-md dark:border-b">
        ...
        <div className="inline-flex rounded-md shadow-sm">
          <button
            ...
            type="button"
            className={`inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 duration-500 border border-gray-200 rounded-s-lg   dark:bg-gray-800 dark:border-gray-700 dark:text-white    ${
              codeOpen === 'Preview' ? 'bg-mainColor dark:bg-mainColor' : ''
            }`}
          >
          ...
          <button
            ...
            type="button"
            className={`inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 duration-500  border border-gray-200  dark:bg-gray-800 dark:border-gray-700 dark:text-white   ${
              codeOpen === 'code' ? 'bg-mainColor dark:bg-mainColor' : ''
            }`}
          >
          ...
          {jsCode && (
            <button
              ...
              type="button"
              className={`inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 duration-500  border border-gray-200  dark:bg-gray-800 dark:border-gray-700 dark:text-white   ${
                codeOpen === 'jsCode' ? 'bg-mainColor dark:bg-mainColor' : ''
              }`}
            >
              <RiCodeSSlashFill className="w-5 h-5 me-1" />
              <span>JS Code</span>
          ...
          {reactCode && (
            <button
              ...
              type="button"
              className={`inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 duration-500  border border-gray-200 rounded-e-lg  dark:bg-gray-800 dark:border-gray-700 dark:text-white   ${
                codeOpen === 'reactCode' ? 'bg-mainColor dark:bg-mainColor' : ''
              }`}
            >
              <RiCodeSSlashFill className="w-5 h-5 me-1" />
              <span>React</span>
        ...
        <div className="relative group">
          ...
          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-white bg-black rounded opacity-0 transition-opacity duration-300 pointer-events-none group-hover:opacity-100 dark:text-black dark:bg-mainColor whitespace-nowrap z-50">
            Large View{' '}
            <span>
              <PiControlFill className="absolute -bottom-2.5 left-7 dark:text-mainColor rotate-180 text-black  z-50 w-7 h-7" />
            </span>
          </div>
        </div>
        ...
        <div className="flex gap-4 max-lg:hidden">
          ...
          <div className="relative group">
            <button
              ...
              className={`flex items-center justify-center w-8 h-8 duration-300 border rounded focus:bg-mainColor ${
                displaySize === 'laptop' ? 'bg-mainColor' : ''
              }`}
            >
            ...
            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-white bg-black rounded opacity-0 transition-opacity duration-300 pointer-events-none group-hover:opacity-100  dark:bg-mainColor dark:text-black whitespace-nowrap z-50">
              Laptop View{' '}
              <span>
                <PiControlFill className="absolute -bottom-2.5 left-9 dark:text-mainColor rotate-180 text-black  z-50 w-7 h-7" />
              </span>
            </div>
          </div>
          ...
          <div className="relative group">
            <button
              ...
              className={`flex items-center justify-center w-8 h-8 duration-300 border rounded focus:bg-mainColor ${
                displaySize === 'tablet' ? 'bg-mainColor' : ''
              }`}
            >
          ...
          <div className="relative group">
            <button
              ...
              className={`flex items-center justify-center w-8 h-8 duration-300 border rounded focus:bg-mainColor ${
                displaySize === 'mobile' ? 'bg-mainColor' : ''
              }`}
            >
      ...
      {codeOpen === 'jsCode' && (
        <CodePreview>
          <div
            className="max-w-sm shiki-code-block"
            dangerouslySetInnerHTML={{ __html: jsHighlightCode }}
          ></div>
        </CodePreview>
      )}
      ...
      {codeOpen === 'reactCode' && (
        <CodePreview>
          <div
            className="max-w-sm shiki-code-block"
            dangerouslySetInnerHTML={{ __html: reHighlightCode }}
          ></div>
        </CodePreview>
      )}
          ...
          >
            <div className="w-full">
              <iframe
                ...
                srcDoc={`<html>
                        <head>
                          ...
                          <script>
                            ...
                            // Send height on resize or DOM changes
                ...
                style={{
                  border: 'none',
                  height: customHight ? customHight : iframeHeight,
                }}
              ></iframe>
            </div>
          </div>
