...
function page() {
  return (
    <div class="max-w-5xl max-lg:max-w-3xl mx-auto bg-white dark:bg-gray-900 my-6 font-[sans-serif]">
      <div class="text-center px-6">
        <h2 class="text-gray-800 dark:text-white text-3xl font-bold">
          Contact Us
        </h2>
            ...
            <div class="grid sm:grid-cols-2 gap-8">
              <div class="relative flex items-center">
                <input
                  ...
                  class="px-2 py-3 bg-white dark:bg-gray-900 w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-500 outline-none"
                />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#bbb"
              ...
              <div class="relative flex items-center">
                <input
                  ...
                  class="px-2 py-3 bg-whit dark:bg-gray-900 w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-500 outline-none"
                />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#bbb"
              ...
              <div class="relative flex items-center">
                <input
                  ...
                  class="px-2 py-3 bg-white dark:bg-gray-900 text-black w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-500 outline-none"
                />
                <svg
                  fill="#bbb"
                  class="w-[18px] h-[18px] absolute right-2"
              ...
              <div class="relative flex items-center sm:col-span-2">
                <textarea
                  ...
                  class="px-2 pt-3 bg-white dark:bg-gray-900 text-black w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-500 outline-none"
                ></textarea>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#bbb"
