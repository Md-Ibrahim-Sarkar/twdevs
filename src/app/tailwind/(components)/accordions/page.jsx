...
import { accordions_1, accordions_2, accordions_3 } from './code';
...
function page() {
  return (
    <div>
      <ComponentsView
        code={accordions_1}
        title="FAQ Search and Support Section"
        link="/components/tailwind/accordions-one"
      >
        <iframe
          srcDoc={`<html>
  <head>
...
<div class="container mx-auto py-12 px-4 max-[640px]:px-1">
    <h1 class="text-center  text-3xl md:text-4xl font-bold">Common Questions</h1>
...
<script>
    ...
    toggles.forEach(toggle => {
      ...
      <ComponentsView
        ...
        link="/components/tailwind/accordions-two"
      >
        <iframe
          srcDoc={`<html>
  <head>
...
<script>
  function toggleFaq(element) {
    ...
    if (isOpen) {
      ...
      <ComponentsView
        code={accordions_3}
        title="Dynamic Radio Accordion"
        link="/components/tailwind/accordions-three"
      >
        <iframe
          srcDoc={`<html>
  <head>
