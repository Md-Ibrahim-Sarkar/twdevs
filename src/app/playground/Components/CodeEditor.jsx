...
export const defaultComponent = `<header class='shadow-lg font-[sans-serif] tracking-wide relative z-50'>
      <section
        ...
        <a href="javascript:void(0)" class="shrink-0 max-sm:hidden"><img
          src="https://ik.imagekit.io/f3bwtdcms/Logos/logo.png?updatedAt=1738778309264" alt="logo" class='sm:w-[150px] w-32' />
        </a>
        <a href="javascript:void(0)" class="hidden max-sm:block"><img src="https://ik.imagekit.io/f3bwtdcms/Logos/logo.png?updatedAt=1738778309264" alt="logo" class='w-[120px]' />
        </a>
        ...
        <div class='flex flex-wrap w-full items-center'>
          ...
          <div class="ml-auto">
            ...
            <ul class='flex items-center'>
              ...
              <li class='max-md:hidden flex items-center text-[15px] max-lg:py-2 px-4 font-medium text-gray-800 cursor-pointer'>
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-2" viewBox="0 0 512 511">
                  <path
              ...
              <li class='flex text-[15px] max-lg:py-2 px-4 hover:text-[#007bff] hover:fill-[#007bff]'>
                <button
                  class='px-4 py-2 text-sm font-semibold text-gray-800 border border-[#333] bg-transparent'>Sign
                  In</button>
              </li>
      ...
      <div id="collapseMenu"
        ...
        <ul
          class='lg:flex lg:flex-wrap lg:items-center lg:justify-center px-10 py-3 bg-[#333] min-h-[46px] gap-4 max-lg:space-y-4 max-lg:fixed max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-lg max-lg:overflow-auto z-50'>
          <li class='mb-6 hidden max-lg:block'>
            <a href="javascript:void(0)"><img src="https://ik.imagekit.io/f3bwtdcms/Logos/logo.png?updatedAt=1738778309264" alt="logo" class='w-36' />
            </a>
          </li>
          <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
            class='hover:text-yellow-300 text-yellow-300 text-[15px] font-medium block'>New</a></li>
          <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
            class='hover:text-yellow-300 text-white text-[15px] font-medium block'>Brands</a></li>
          <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
