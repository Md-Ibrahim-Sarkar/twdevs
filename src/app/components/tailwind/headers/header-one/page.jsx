...
function page() {
  return (
    <FullComponentsView
      ...
      description="oij"
      customHight="200px"
      title="Header with Logo, Navigation, Actions, and Mobile Menu"
    >
      <header class="flex shadow-lg py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50">
        <div class="flex flex-wrap items-center justify-between gap-4 w-full">
          ...
          >
            <img src="/nav-logo.png" alt="logo" class="w-36" />
          </a>
          ...
          >
            ...
            <ul class="lg:flex lg:gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
              ...
              <li class="max-lg:border-b max-lg:py-3 px-3">
                <a
                  href="javascript:void(0)"
                  class="hover:text-[#84c6d9] text-[#39CBF5] block font-semibold text-[15px]"
                >
                  Home
                </a>
              </li>
              <li class="max-lg:border-b max-lg:py-3 px-3">
                <a
                  href="javascript:void(0)"
                  class="hover:text-[#39CBF5] text-[#333] block font-semibold text-[15px]"
                >
                  About
                </a>
              </li>
          ...
          <div class="flex items-center ml-auto space-x-6">
            <button class="font-semibold text-[15px] border-none outline-none">
              <a
                href="javascript:void(0)"
                class="text-[#39CBF5] hover:underline"
              >
                Login
              </a>
            </button>
            <button class="px-4 py-2 text-sm rounded-sm font-bold text-white border-2 border-[#39CBF5] bg-[#39CBF5] transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#39CBF5]">
              Sign up
            </button>
