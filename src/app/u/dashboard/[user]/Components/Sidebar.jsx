...
const Sidebar = () => {
  ...
  return (
    <>
      <nav className=" min-w-[260px] max-[1074px]:hidden font-[sans-serif] flex flex-col">
        <nav class="  min-w-[250px]  px-4 font-[sans-serif] ">
          <div class=" h-full mt-4">
            <div className="flex flex-wrap flex-col justify-center items-center cursor-pointer">
              <div className="">
                <img src={`${user?.reloadUserInfo.photoUrl}`} className="rounded-full w-24 h-24" />
              </div>
            ...
            <div className="min-h-[180px] max-w-[228px] p-4 flex flex-col bg-[#d9f3ea] rounded-3xl mt-4">
              ...
              <div className="mt-2">
                <p className="text-sm text-gray-600 text-center font-semibold">Welcome, Ibrhaim</p>

                <Image className="mt-3" src='/logos/logo.png' alt="Logo" width={150} height={50} />
              </div>
            </div>
          </div>
        </nav>
